...
![GitHub repository](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/01-github-repository.png)

Commit history showing the iterative pipeline development:

![Commit history](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/02-commit-history.png)
...
![Pipeline stage view](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/06-pipeline-stage-view.png)
...
![Jenkins job general configuration](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/03-jenkins-job-general-config.png)

Pipeline definition pulling the `Jenkinsfile` from the Git repository:

![Jenkins pipeline SCM configuration](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/04-jenkins-pipeline-scm-config.png)

Branch specifier and `Script Path` set to `Jenkinsfile`:

![Jenkins pipeline script path](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/05-jenkins-pipeline-script-path.png)

Console output of the Maven build executing from the checked-out pipeline:

![Maven build console output](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/12-maven-build-console.png)
...
![Parallel stages running concurrently](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/07-parallel-stages-console.png)
...
![Jenkins agent online](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/08-jenkins-agent-online.png)

The `Package` stage executing on the remote agent (`Running on Linux-Agent`):

![Package stage running on the agent](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/09-package-stage-on-agent.png)
...
![SonarQube quality gate passed](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/10-sonarqube-quality-gate-passed.png)

Issues view (0 bugs, 0 vulnerabilities, 1 code smell):

![SonarQube issues](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/11-sonarqube-issues.png)
...
![JaCoCo coverage report](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/13-jacoco-coverage-report.png)

The pipeline produces and archives the runnable jar
`employee-management-ci-demo-1.0.0.jar`:

![Build artifact in target directory](https://raw.githubusercontent.com/LikithKumar0112/Jenkins-Capstone-Project/screenshots/Screenshots/14-build-artifact.png)
